...
<script lang="ts">
	...
	const SPRITE_SCALE = { width: 1.25, height: 1.02 };
	const POSITION_ADJUSTMENTx = 1.01;
	const POSITION_ADJUSTMENT = 0.8;
...
{#if animationName}
	<SpineProvider
		zIndex={-1}
		key="reelhouse"
		x={context.stateGameDerived.boardLayout().x * POSITION_ADJUSTMENTx}
